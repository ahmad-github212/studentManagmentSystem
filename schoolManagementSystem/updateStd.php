        ...
        <div class="row2" style=" margin-top:20px;">
            <div style="background-color:white;margin-bottom:10px; padding:5px;font-size:17px;
                        ...
                        <input type="text" class="input" id='name' name='name'
                         style="outline:none;margin-left:20px;margin-right:40px;margin-bottom:5px;"
                         placeholder="enter name" value="<?php echo $name ?>">
                        
                        <input type="number" class="input" name='rollno' 
                        style="outline:none;margin-left:10px;margin-right:40px"placeholder="enter id"
                        value="<?php echo $rn ?>">
                        
                        <input type="number"class="input" name='class'
                        style="outline:none;margin-left:10px;"
                        value="<?php echo $class ?>" placeholder="enter qualifications"><br>

                        <input type="text" class="input" name= 'address'
                        style="outline:none;margin-left:122px;margin-right:40px;"placeholder="enter address"
                        value="<?php echo $address ?>">

                        <input type="text" class="input" name='dob'
                        style="outline:none;margin-left:10px;margin-right:40px;"placeholder="enter Dob"
                        value="<?php echo $dob ?>">
                        ...
                        <?php
                                ...
                                $updateQuery = "UPDATE studentinfoTable SET Name='$name', RollNo='$rollno',
                                Class='$class', Dob='$dob', Address='$address' WHERE RollNo='$rn'";

                                $updateQueryRun = mysqli_query($connect,$updateQuery);
